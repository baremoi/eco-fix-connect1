...
export default function ProviderReviews({ reviews, isLoading, averageRating, totalReviews }: ProviderReviewsProps) {
  if (isLoading) {
    return (
    ...
    <div>
      <div className="mb-8 p-6 bg-gray-50 rounded-lg">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h3 className="text-2xl font-bold">{averageRating.toFixed(1)} / 5</h3>
